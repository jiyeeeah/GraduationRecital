...
export default function Irony() {
  ...
  return (
    <div className="text-[#355692] absolute top-0 min-h-real-screen flex flex-col gap-8 pl-10 pr-3 pt-10 font-BKK ">
      ...
      <div className="flex flex-col gap-3 text-sm mb-28">
        <p>
          이 곡은 프랑스 작가 ‘알베르 카뮈’의 {"<"}여름{">"}이라는 글에서 읽은 “우리는 모순을 안고
          있지만, 모순을 거부해야 한다.”라는 한 문장에 영감을 받아 작곡되었습니다.
        </p>
        <p>
          세상은 모순 덩어리입니다. 모든 상황, 모든 관계, 모든 경우에서 작은 형태라도 ‘모순’이란
          것은 반드시 존재한다고 생각해요. 얽히고 얽힌 모순의 세상에서, 모순을 받아들이면서 배척해야
          한다는 이 문장 자체도 사실상 모순의 문장인 것이니까요. 그럼에도 불구하고 이 세상은
          모순적이기에 흥미로운 것이라 생각합니다. 인생에서의 모순을 하나하나 받아들이면서 스스로의
