  ...
  return (
    ...
    >
      <div className="flex flex-col items-center w-full font-ICEJaram">
        ...
        <p className="self-end pr-10 text-3xl text-right text-[#60748a] font-semibold">
          작곡 이지예
        </p>
      </div>
      <div className="flex flex-col gap-5 text-center text-2xl font-NanumJungHagSaeng bg-gradient-to-b from-[#60748a] to-[#c07e6d] bg-clip-text text-transparent p-3 mb-96">
